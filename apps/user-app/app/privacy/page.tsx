...
export const metadata: Metadata = {
  title: 'Privacy Policy | Paywall',
  description: 'Privacy Policy for Paywall digital wallet application',
};
      ...
      <div className="max-w-3xl mx-auto pt-20">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-semibold tracking-tight text-white sm:text-4xl">
            <span className="text-cyan-300">Paywall </span>Privacy Policy
          </h1>
        ...
        <div className="glass-panel space-y-6 rounded-2xl p-6 text-sm leading-7 text-slate-400 sm:p-8">
          <section>
            ...
            <p>
              Welcome to Paywall's Privacy Policy. This policy describes how we
          ...
          <section>
            ...
            <p>
              ...
              contact us at privacy@paywall.com.
            </p>
          </section>
