...
If you discover a vulnerability in Paywall, please report it responsibly. We are committed to ensuring the security of our users, and we appreciate your help in identifying and addressing potential security issues.

### Steps for Reporting a Vulnerability:

1. **Do not disclose the vulnerability publicly** until it has been addressed.
2. **Email your report** to the repository maintainer at [support@paywall.com](mailto:support@paywall.com).
...
We support the following versions of Paywall with security updates:
...
We encourage all users and contributors to follow security best practices when developing and using Paywall:
...
Thank you for helping us keep Paywall secure!
